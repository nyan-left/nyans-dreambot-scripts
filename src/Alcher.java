...
import static org.dreambot.api.methods.magic.Normal.CAMELOT_TELEPORT;
...
public class Alcher {
    ...
    public static boolean hasRequirements() {
        return Magic.canCast(Normal.HIGH_LEVEL_ALCHEMY) && Magic.canCast(CAMELOT_TELEPORT);
    }
    ...
    private static void castCamelotTeleport() {
        Magic.castSpell(CAMELOT_TELEPORT);
